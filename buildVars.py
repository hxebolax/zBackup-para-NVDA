...
addon_info = {
	...
	"addon_summary": _("zBackup para NVDA"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Hacer y restaurar copias de seguridad de la partición Windows"""),
	# version
	"addon_version": "0.1",
	# Author(s)
	"addon_author": u"Héctor J. Benítez Corredera <xebolax@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/hxebolax/zBackup-para-NVDA",
...
pythonSources = [os.path.join("addon", "globalPlugins", "zBackup", "*.py")]
